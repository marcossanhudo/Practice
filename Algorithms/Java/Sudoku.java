/*
	...
	The search performed by this algorithm can be classified as "Depth-First Search" ("DFS"),
	because the algorithm tries each branch, as close to finishing the branch as possible;
	if that branch is finished -- or, in the case of backtracking, discarded --,
	the algorithm will search through all other remaining branches, ordered by their closest shared ancestor.
	...
	be inserted in that space; if, after that insertion, if the algorithm later finds out
